...
# Complete Database Export and Conversion Workflow
# This script combines pg_dump export with Liquibase conversion
...
echo -e "${GREEN}🚀 PostgreSQL to Liquibase Export Workflow${NC}"
echo "============================================="
echo ""
...
echo -e "${BLUE}📤 Step 1: Exporting database using pg_dump...${NC}"
...
echo -e "${YELLOW}🗃️  pg_dump exports (exports/):${NC}"
...
echo ""
echo -e "${GREEN}🎉 Complete export workflow finished successfully!${NC}"
echo ""
